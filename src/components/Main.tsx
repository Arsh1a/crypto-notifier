...
const selectedCurrencies5 =
  "STRK,METIS,TURBO,CGPT,COOKIE,DEXE,ATH,NEIRO,MORPHO,FORM,RENDER,WIF,CAT,BANK,PEPE,NET,BABYDOGE,FLOKI,KAITO,VIRTUAL,AIXBT,TNSR,RAY,ORCA,PNUT,LAYER,IO,JUP,PENGU,JTO,PYTH,BOME,SAHARA,SYRUP";
function Main() {
